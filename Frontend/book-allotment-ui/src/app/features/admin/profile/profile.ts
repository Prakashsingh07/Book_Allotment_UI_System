    ...
    <div class="w-full max-w-md">
      <div class="relative bg-slate-900/80 backdrop-blur-xl border border-white/10 rounded-3xl overflow-hidden shadow-2xl">
          ...
          <div class="relative">
            ...
            <div class="relative inline-block mb-4">
              ...
              <div class="w-24 h-24 rounded-2xl border-2 border-white/20 shadow-xl overflow-hidden cursor-pointer"
                ...
                <div *ngIf="!avatarUrl"
                     class="w-full h-full bg-gradient-to-br from-amber-500 to-orange-500
              ...
              <button type="button" (click)="fileInput.click()"
                      class="absolute -bottom-2 -right-2 w-8 h-8 rounded-xl bg-amber-500 border-2 border-slate-900
            ...
            <p class="text-amber-200/40 text-xs mt-1">Click the photo to change it</p>
            <span class="inline-block mt-2 px-3 py-0.5 rounded-full text-xs font-bold
        ...
        <div *ngIf="loadingProfile" class="px-8 py-10 flex flex-col gap-4">
          ...
          <div class="h-12 bg-white/5 rounded-xl animate-pulse"></div>
          <div class="h-12 bg-white/5 rounded-xl animate-pulse mt-4"></div>
        </div>
        ...
        <div *ngIf="!loadingProfile" class="px-8 py-8">
          <form [formGroup]="profileForm" (ngSubmit)="updateProfile()" class="space-y-5">
            ...
            <div>
              ...
              <div class="relative">
                <div class="absolute left-3.5 top-1/2 -translate-y-1/2">
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-white/30" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>
                </div>
                <input type="text" formControlName="name" placeholder="Enter your full name"
                       class="w-full bg-white/5 border text-white placeholder-white/20 rounded-xl pl-10 pr-4 py-3 text-sm transition-all duration-200 focus:outline-none focus:ring-2"
                       [ngClass]="profileForm.get('name')?.invalid && profileForm.get('name')?.touched
                         ? 'border-rose-500/50 focus:ring-rose-500/30' : 'border-white/10 focus:ring-amber-500/40 focus:border-amber-500/50'" />
              </div>
            ...
            <div>
              ...
              <div class="relative">
                <div class="absolute left-3.5 top-1/2 -translate-y-1/2">
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-white/30" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                </div>
            ...
            <div>
              ...
              <div class="relative">
                <div class="absolute left-3.5 top-1/2 -translate-y-1/2">
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-white/30" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" /></svg>
                </div>
                <input [type]="showCurrent ? 'text' : 'password'" formControlName="currentPassword"
                       placeholder="Enter your current password"
                       class="w-full bg-white/5 border text-white placeholder-white/20 rounded-xl pl-10 pr-11 py-3 text-sm transition-all duration-200 focus:outline-none focus:ring-2"
...
export class AdminProfileComponent implements OnInit {
  ...
  private readonly AVATAR_KEY = 'admin_profile_avatar';
