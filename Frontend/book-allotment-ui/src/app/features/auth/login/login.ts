      ...
      <div class="relative z-10 max-w-md text-center space-y-8">
        ...
        <div>
          <h2 class="text-4xl font-extrabold text-white leading-tight">
            ...
            <span class="bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent">Library Hub</span>
          </h2>
        ...
        <div class="flex flex-wrap justify-center gap-2">
          <span *ngFor="let f of features" class="px-3 py-1.5 rounded-full text-xs font-semibold bg-white/5 text-white/60 border border-white/10">{{ f }}</span>
        </div>
        ...
        <div class="relative bg-slate-900/80 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
          ...
          <div class="mt-6 pt-6 border-t border-white/5 text-center">
            <p class="text-white/40 text-sm">
              ...
              <a routerLink="/register" class="text-indigo-400 hover:text-indigo-300 font-semibold ml-1 transition-colors">Create one →</a>
            </p>
          </div>
